...
import com.example.code_android.utils.executionlocker.withExecutionLocker
import com.example.code_android.utils.getCurrencySymbol
import com.example.core.utils.logger.GzLogger
import com.example.trip.heaven.ui.R
import com.google.accompanist.systemuicontroller.rememberSystemUiController
import com.example.trip_heaven_ui.ui.theme.Background
import com.example.trip_heaven_ui.ui.theme.GoZayaanTheme
import com.example.trip_heaven_ui.ui.theme.Surface
import com.example.trip_heaven_ui.ui.theme.gradient
import com.example.trip_heaven_ui.utils.RubikFontBold
import com.example.trip_heaven_ui.utils.RubikFontMedium
import com.example.trip_heaven_ui.utils.RubikFontRegular
import com.example.trip_heaven_ui.ui.composable.AutoImageSlider
import com.example.trip_heaven_ui.ui.composable.BottomNavGraph
import com.example.trip_heaven_ui.ui.composable.CategoryGrid
import com.example.trip_heaven_ui.ui.composable.CircularProgressBar
import com.example.trip_heaven_ui.ui.composable.FloatingNavigationBar
import com.example.trip_heaven_ui.ui.composable.GlobalTopBar
import com.example.trip_heaven_ui.ui.composable.HomeTopBar
import com.example.trip_heaven_ui.ui.composable.RecommendationCardVertical
import com.example.trip_heaven_ui.ui.composable.RecommendedRow
import com.example.trip_heaven_ui.ui.composable.SearchBar
        ...
        LazyVerticalGrid(
            ...
            if (isSearch) {
                uiState.response?.let { items ->
                    ...
                    val filteredList = mutableListOf<com.example.trip_heaven_core.data.model.DestinationResponse.DestinationResponseItem>()
                    items.forEach { item ->
 ...
 */
@Composable
fun DetailsScreen(item: com.example.trip_heaven_core.data.model.DestinationResponse.DestinationResponseItem?, navController: NavController) {
